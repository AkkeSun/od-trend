...
class RecommendShard1Entity {
    ...
    @Builder
    RecommendShard1Entity(Long id, Long productId, String type, LocalDate checkDate,
    ...
    static RecommendShard1Entity of(ProductRecommend recommend) {
        return RecommendShard1Entity.builder()

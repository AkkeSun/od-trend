...
class NaverProductNormalizerTest extends IntegrationTestSupport {

    @Autowired
    NaverProductNormalizer naverProductNormalizer;
    ...
    class Describe_normalize {
        ...
        void success() {
            // given
            NaverProductNormalizer naverProductNormalizer = new NaverProductNormalizer();
            ...
            // when
            List<CrawlingProduct> result = naverProductNormalizer.normalize(crawlingPage,
        ...
        void error() {
            ...
            CustomBusinessException exception = assertThrows(CustomBusinessException.class, () -> {
                naverProductNormalizer.normalize(crawlingPage, transactionId, crawlingResult);
            });

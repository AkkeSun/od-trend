...
class RecommendShard2AdapterTest extends IntegrationTestSupport {

    @Autowired
    RecommendShard2Adapter adapter;

    @Autowired
    RecommendShard2Repository repository;
    ...
    class Describe_existsByCheckDate {
        ...
        void success() {
            ...
            RecommendShard2Entity entity = RecommendShard2Entity.builder()
                .id(1L)
                .productId(1L)
                .type("TREND")
                .checkDate(checkDate)
